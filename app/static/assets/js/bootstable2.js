...
function editTable(){
  ...
  $('table tr').editable({
    ...
    save: function(values) {
      $(".edit span", this)
        .removeClass('glyphicon glyphicon-floppy-disk')
...
$(".add-row").click(function(){
  $("#editableTable").find("tbody tr:first").before("<tr><td data-field='code'></td><td data-field='vrn'></td><td data-field='name'></td><td><a class='btn btn-sm btn-default edit' title='Edit'><span class='glyphicon glyphicon-edit'></span></a> <a class='btn btn-sm btn-default' title='Delete'><span class='glyphicon glyphicon-trash'></span></a></td></tr>");   
  editTable();  
  setTimeout(function(){   
